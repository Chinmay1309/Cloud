...
<table align="center" border="0.5" cellspacing="10" cellpadding="8" class="tabtheme" style="margin-top:150px;width:500px;height:300px;font-size:24px;margin-right:520px;">
    ...
    <tr align="center">
        <td colspan="2"><img src="Media2/course.png" width="200px" height="200px" ></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <select class="tab"  onchange="goToPage(this.value)">
                ...
                <option value="EngineeringPageStatic.jsp">Engineering</option>
                <option value="CommercePageCareer.jsp">Commerce</option>
                <option value="MedicalPageGuide.jsp">Medical Science</option>
                <option value="ArtsPage.jsp">Arts</option>
