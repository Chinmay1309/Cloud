...
<table align="center" border="0.5" cellspacing="10" cellpadding="8" class="tabtheme" style="margin-top:150px;width:500px;height:300px;font-size:24px;margin-right:487px;">

    
    <tr align="center">
        <td colspan="2"><img src="Media2/Learning.png" width="400px" height="200px" style="margin-left:130px;" ></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <select class="tab"  onchange="goToPage(this.value)">
                ...
                <option value="EngineeringLearn.jsp">Engineering</option>
                <option value="CommerceLearn.jsp">Commerce</option>
                <option value="MedicalLearn.jsp">Medical Science</option>
                <option value="ArtsLearn.jsp">Arts</option>
